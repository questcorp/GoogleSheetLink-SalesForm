...
function provideDetails(){
  ...
  $.getJSON(url, function (json) {
    ...
    if(opt.value == eventz[kk]){
      ...
      document.getElementById('date').innerHTML = "Date: "+ new Date(json.records[index[kk]].Date).toDateString();
      document.getElementById('time').innerHTML = "Time: "+ new Date(json.records[index[kk]].Time_Start).toLocaleTimeString();
      document.getElementById('Venue').innerHTML = "Venue/Hosting Platform: "+ json.records[index[kk]].Host_Venue;
      createHeader();
      var pricingTable = document.getElementById('Pricing');
      ...
      document.getElementById('Venue').innerHTML = "Venue/Hosting Platform: Wisam Quest";
      var pricingTable = document.getElementById('Pricing');
      pricingTable.innerHTML = "";
      createHeader();
      var tr =  pricingTable.insertRow(-1);
