...
function checkConditionb4AddRow(){
  if(countz>=6){
    ...
    if(countz ==0 || document.getElementsByClassName('Quantitz')[totalRowIndex-1].value !=0){
      setnone();
      document.getElementById('Add').style.marginTop = "0px";
...
function addRow(){
  ...
  button.onclick = function(){
    ...
    document.getElementById('Step5').innerHTML = "Step 9:<br>&#9664 Select MYR / USD";
    document.getElementById('Step5').style.top = "210px";
    document.getElementById('Step5').style.marginTop = "-138px";
    document.getElementById('Step5').style.left = "65%";
    document.getElementById('Choice').style.marginTop = "0px";
    document.getElementById('Step6').innerHTML = "Step 10<br>Enter the Price<br>&#9660";
    document.getElementById('FullPayment').style.marginTop = "40px";
    document.getElementById('Step7').innerHTML = "Step 11<br>Enter the Quantity<br>&#9660";
    document.getElementById('Step6').style.display = "block";
    document.getElementById('Step6').style.top = "100px";
  ...
  function updatePopUp(count){
    ...
    input.onchange = function(){
      ...
      document.getElementById('Step7').style.top = "100px";
      document.getElementById('Step7').style.left = "32%";
      document.getElementById('Choice').style.marginTop = "0px";
      totalUpOthers();
    }
    tabCell.appendChild(input);
    ...
    input.onchange = function(){
      ...
      document.getElementById('Step6').style.display = "block";
      document.getElementById('Step6').style.top= "210px";
      document.getElementById('FullPayment').style.marginTop= "0px";
      document.getElementById('Step7').style.top= "210px";
      document.getElementById('Step7').style.left= "50%";
      document.getElementById('Step7').style.display = "block";
      document.getElementById('Step6').innerHTML = "Step 12:<br> Saving the Data<br>&#9660";
      document.getElementById('Step7').innerHTML = "Step 13:<br>  Cancel without saving<br>&#9660";
...
function differentiate(){
  ...
  if(addRowz == true){
    ...
    document.getElementById('Step8').style.top = "-220px";
    document.getElementById('Step9').style.top = "-120px";
